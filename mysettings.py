...
DATABASES = {
    'default': {
        ...
        'NAME': 'localcode2',                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = '/home/pwz/open-reblock/media/'#'/Library/WebServer/Documents/media/localcode/' # LOCAL DEVELOPMENT
